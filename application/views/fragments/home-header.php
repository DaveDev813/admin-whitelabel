...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?= base_url() ?>assets/admin-lte/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?= base_url() ?>assets/admin-lte/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  ...
  <link rel="stylesheet" href="<?= base_url() ?>assets/admin-lte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
